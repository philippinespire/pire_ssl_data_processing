...
The purpose of this repository is to provide replicable steps for de novo genome assembly of *H. miniatus* as outlined by Dr. Eric Garcia in the [PIRE Shotgun Data Processing and Analysis Page](github.comom/philippinespire/pire_ssl_data_processing) of the [PhilippinesPIRE](github.comom/philippinespire) repository.  All scripts and software used are explained on the PIRE Shotgun repository.  All bioinformatic work was performed on the Old Dominion University High Performance Computing Cluster.
...
A complete log of all work can be found in the [README.md]() of this repository's subdirectory logs.
***
